...
TVM_FFI_STATIC_INIT_BLOCK({
  ...
  *rv = shape(args[0].cast<te::Tensor>(), args[1].cast<DataType>());
  ...
  if (args[1].try_cast<int>()) {
    ...
    *rv = split_indices_array(args[0].cast<te::Tensor>(), args[1].cast<Array<Integer>>(),
    ...
    .def_packed("topi.layout_transform", [](ffi::PackedArgs args, ffi::Any* rv) {
      *rv = layout_transform(args[0].cast<te::Tensor>(), args[1].cast<std::string>(),
                             args[2].cast<std::string>(), args[3].cast<std::string>());
    })
    .def_packed("topi.take", [](ffi::PackedArgs args, ffi::Any* rv) {
  if (args.size() == 4) {
  ...
  *rv = gather_nd(args[0].cast<te::Tensor>(), args[1].cast<te::Tensor>(), batch_dims);
  ...
  switch (args.size()) {
    ...
    .def_packed("topi.tensordot", [](ffi::PackedArgs args, ffi::Any* rv) {
  if (args.size() == 2) {
    ...
    *rv = tensordot(args[0].cast<te::Tensor>(), args[1].cast<te::Tensor>(),
    ...
    .def_packed("topi.strided_slice", [](ffi::PackedArgs args, ffi::Any* rv) {
    ...
    .def_packed("topi.dynamic_strided_slice", [](ffi::PackedArgs args, ffi::Any* rv) {
    ...
    .def("topi.relax_dynamic_strided_slice", [](te::Tensor x, te::Tensor begin, te::Tensor end, te::Tensor strides,
                       Array<PrimExpr> output_shape) {
      return relax::dynamic_strided_slice(x, begin, end, strides, output_shape);
    })
    .def_packed("topi.one_hot", [](ffi::PackedArgs args, ffi::Any* rv) {
  ...
  *rv = one_hot(args[0].cast<te::Tensor>(), args[1].cast<PrimExpr>(), args[2].cast<PrimExpr>(),
    ...
    .def_packed("topi.matrix_set_diag", [](ffi::PackedArgs args, ffi::Any* rv) {
    ...
    .def("topi.adv_index", [](te::Tensor x, Array<te::Tensor> indices) { return adv_index(x, indices); });
});
