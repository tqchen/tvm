...
class HipblasJSONSerializer : public JSONSerializer {
 public:
  HipblasJSONSerializer(Map<Constant, ffi::String> constant_names, Map<Var, Expr> bindings)
...
Array<ffi::Module> HipblasCompiler(Array<Function> functions, Map<ffi::String, ffi::Any> /*unused*/,
