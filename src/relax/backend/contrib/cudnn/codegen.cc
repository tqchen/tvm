...
class cuDNNJSONSerializer : public JSONSerializer {
 public:
  cuDNNJSONSerializer(Map<Constant, ffi::String> constant_names, Map<Var, Expr> bindings)
...
Array<ffi::Module> cuDNNCompiler(Array<Function> functions, Map<ffi::String, ffi::Any> /*unused*/,
