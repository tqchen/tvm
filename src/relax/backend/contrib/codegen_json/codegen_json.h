...
class JSONSerializer : public relax::MemoizedExprTranslator<NodeEntries> {
 public:
   ...
   */
  explicit JSONSerializer(const Map<Constant, ffi::String>& constant_names)
  ...
  Array<ffi::String> GetConstantNames() const { return constants_used_; }
 ...
 private:
  ...
  Array<ffi::String> constants_used_;
  /*! \brief The names of all constants in the original module. */
  const Map<Constant, ffi::String>& constant_names_;
};
