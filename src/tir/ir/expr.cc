...
TVM_FFI_STATIC_INIT_BLOCK({
  ...
  refl::GlobalDef()
    .def("tir.convert", [](Variant<PrimExpr, Array<PrimExpr>> expr) {
  return expr;
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Var", [](String name_hint, ffi::AnyView type,
                                                     Span span) {
  if (type.as<Type>()) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.SizeVar", [](String s, DataType t, Span span) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.IterVar", [](Range dom, Var var, int iter_type, String thread_tag, Span span) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.StringImm", [](String value, Span span) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Cast", [](DataType dtype, PrimExpr value, Span span) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Add", [](PrimExpr a, PrimExpr b, Span span) {
  return Add(a, b, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Sub", [](PrimExpr a, PrimExpr b, Span span) {
  return Sub(a, b, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Mul", [](PrimExpr a, PrimExpr b, Span span) {
  return Mul(a, b, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Div", [](PrimExpr a, PrimExpr b, Span span) {
  return Div(a, b, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Mod", [](PrimExpr a, PrimExpr b, Span span) {
  return Mod(a, b, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.FloorDiv", [](PrimExpr a, PrimExpr b, Span span) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.FloorMod", [](PrimExpr a, PrimExpr b, Span span) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Min", [](PrimExpr a, PrimExpr b, Span span) {
  return Min(a, b, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Max", [](PrimExpr a, PrimExpr b, Span span) {
  return Max(a, b, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.EQ", [](PrimExpr a, PrimExpr b, Span span) {
  return EQ(a, b, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.NE", [](PrimExpr a, PrimExpr b, Span span) {
  return NE(a, b, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.LT", [](PrimExpr a, PrimExpr b, Span span) {
  return LT(a, b, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.LE", [](PrimExpr a, PrimExpr b, Span span) {
  return LE(a, b, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.GT", [](PrimExpr a, PrimExpr b, Span span) {
  return GT(a, b, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.GE", [](PrimExpr a, PrimExpr b, Span span) {
  return GE(a, b, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.And", [](PrimExpr a, PrimExpr b, Span span) {
  return And(a, b, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Or", [](PrimExpr a, PrimExpr b, Span span) {
  return Or(a, b, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Not", [](PrimExpr a, Span span) {
  return Not(a, span);
});
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Select", [](PrimExpr condition, PrimExpr true_value, PrimExpr false_value, Span span) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Ramp", [](PrimExpr base, PrimExpr stride, PrimExpr lanes, Span span) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Broadcast", [](PrimExpr value, PrimExpr lanes, Span span) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Let", [](Var var, PrimExpr value, PrimExpr body,
                                                     Span span) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Call", [](Optional<DataType> dtype, RelaxExpr op,
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Shuffle", [](Array<PrimExpr> vectors, Array<PrimExpr> indices, Span span) {
      return Shuffle(vectors, indices, span);
    });
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.CommReducer", [](Array<Var> lhs, Array<Var> rhs, Array<PrimExpr> result,
                       Array<PrimExpr> identity_element, Span span) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.Reduce", [](CommReducer combiner, Array<PrimExpr> source, Array<IterVar> axis,
                       PrimExpr condition, int value_index, Array<PrimExpr> init, Span span) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.BufferLoad", [](Buffer buffer, Array<PrimExpr> indices, Optional<PrimExpr> predicate,
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.ProducerLoad", [](DataProducer producer, Array<PrimExpr> indices, Span span) {
