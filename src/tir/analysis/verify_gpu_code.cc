...
std::vector<ffi::String> VerifyGPUCode_(const PrimFunc& func, Map<ffi::String, PrimExpr> constraints) {
...
bool VerifyGPUCode(const PrimFunc& func, Map<ffi::String, PrimExpr> constraints) {
...
Pass VerifyGPUCode(Map<ffi::String, PrimExpr> constraints) {
