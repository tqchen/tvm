...
TVM_FFI_STATIC_INIT_BLOCK({
  ...
  refl::GlobalDef()
    ...
    .def("tir.schedule.ConcreteSchedule", [](IRModule mod, support::LinearCongruentialEngine::TRandState seed,
    ...
    .def("tir.schedule.TracedSchedule", [](IRModule mod, support::LinearCongruentialEngine::TRandState seed,
                       int debug_mask, int error_render_level, bool enable_check) -> Schedule {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.schedule.ScheduleGet", [](Schedule self, ObjectRef obj) -> ObjectRef {
    ...
    .def("tir.schedule.ScheduleGetSRef", [](Schedule self, ObjectRef obj) -> Optional<ObjectRef> {
      if (auto loop_rv = obj.as<LoopRV>()) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  ...
  refl::GlobalDef()
    ...
    .def_method("tir.schedule.ScheduleSamplePartitionedTile", &ScheduleNode::SamplePartitionedTile)
    .def_method("tir.schedule.ScheduleSampleComputeLocation", &ScheduleNode::SampleComputeLocation);
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  ...
  refl::GlobalDef()
    ...
    .def("tir.schedule.ScheduleGetChildBlocks", [](Schedule self, ObjectRef rv) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  ...
  refl::GlobalDef()
    ...
    .def("tir.schedule.ScheduleReIndex", [](Schedule self, const BlockRV& block_rv, int buffer_index,
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.schedule.ScheduleBlockize", [](Schedule self, ObjectRef target, bool preserve_unit_iters) {
    ...
    .def("tir.schedule.ScheduleTensorize", [](Schedule self, ObjectRef rv, String intrin, bool preserve_unit_iters) {
      if (auto block_rv = rv.as<BlockRV>()) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.schedule.ScheduleAnnotate", [](Schedule self, ObjectRef rv, const String& ann_key, const Any& ann_val) {
      if (auto block_rv = rv.as<BlockRV>()) {
    ...
    .def("tir.schedule.ScheduleUnannotate", [](Schedule self, ObjectRef rv, const String& ann_key) {
      if (auto block_rv = rv.as<BlockRV>()) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.schedule.ScheduleTransformLayout", [](Schedule self, const BlockRV& block_rv, int buffer_index,
    ...
    .def("tir.schedule.ScheduleSetAxisSeparator", [](Schedule self, const BlockRV& block_rv, int buffer_index,
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def_method("tir.schedule.ScheduleRollingBuffer", &ScheduleNode::RollingBuffer);
});
/******** (FFI) Misc ********/
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    ...
    .def_method("tir.schedule.ScheduleUnsafeHideBufferAccess", &ScheduleNode::UnsafeHideBufferAccess);
});
/******** (FFI) Annotate buffer access ********/
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("tir.schedule.ScheduleAnnotateBufferAccess", [](Schedule self, const BlockRV& block_rv, int buffer_index,
                       int buffer_index_type, const IndexMap& index_map) {
