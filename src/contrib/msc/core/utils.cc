...
const Array<ffi::String> StringUtils::Split(const ffi::String& src_string, const ffi::String& sep) {
  Array<ffi::String> sub_strings;
  if (src_string.size() == 0) {
    return sub_strings;
  }
...
const ffi::String StringUtils::Join(const Array<ffi::String>& sub_strings, const ffi::String& joint) {
  ffi::String join_str = "";
...
const std::tuple<ffi::String, ffi::String> StringUtils::SplitOnce(const ffi::String& src_string, const ffi::String& sep,
                                                        bool from_left) {
  if (src_string.size() == 0) {
...
const Array<ffi::String> StringUtils::GetClosures(const ffi::String& src_string, const ffi::String& left,
                                             const ffi::String& right) {
  Array<ffi::String> tokens;
  if (src_string.size() == 0) {
    return tokens;
  }
...
const ffi::String StringUtils::GetClosureOnce(const ffi::String& src_string, const ffi::String& left,
                                         const ffi::String& right, bool from_left) {
  if (src_string.size() == 0) {
    return "";
  }
...
bool ArrayUtils::CompareArrays(const Array<ffi::String>& left, const Array<ffi::String>& right, int size) {
...
const Span SpanUtils::SetAttr(const Span& span, const ffi::String& key, const ffi::String& value) {
  ...
  Array<ffi::String> tokens{"<" + key + ">", "</" + key + ">"};
...
const Map<ffi::String, ffi::String> SpanUtils::GetAttrs(const Span& span) {
...
const Array<ffi::String> ExprUtils::GetInputTypes(const ffi::String& optype, size_t inputs_num,
                                             bool as_relax) {
...
const Array<ffi::String> ExprUtils::GetInputTypes(const Call& call) {
