...
class StringUtils {
 public:
   ...
   */
  TVM_DLL static const Array<ffi::String> Split(const ffi::String& src_string, const ffi::String& sep);

  /*!
   * \brief Join the SubStrings into String.
   * \return The String.
   */
  TVM_DLL static const ffi::String Join(const Array<ffi::String>& sub_strings, const ffi::String& joint);
   ...
   */
  TVM_DLL static const ffi::String Replace(const ffi::String& src_string, const ffi::String& old_str,
   ...
   * \return The Tokens.
   */
  TVM_DLL static const Array<ffi::String> GetClosures(const ffi::String& src_string, const ffi::String& left,
   ...
   * \return The Token.
   */
  TVM_DLL static const ffi::String GetClosureOnce(const ffi::String& src_string, const ffi::String& left,
                                             const ffi::String& right, bool from_left = true);
...
class ArrayUtils {
 public:
   ...
   */
  TVM_DLL static bool CompareArrays(const Array<ffi::String>& left, const Array<ffi::String>& right,
                                    int size = -1);
  /*!
...
class SpanUtils {
 public:
   ...
   * \return The new Span.
   */
  TVM_DLL static const Span SetAttr(const Span& span, const ffi::String& key, const ffi::String& value);
   ...
   */
  TVM_DLL static const Map<ffi::String, ffi::String> GetAttrs(const Span& span);
...
class ExprUtils {
 public:
   ...
   */
  TVM_DLL static const Array<ffi::String> GetInputTypes(const ffi::String& optype, size_t inputs_num,
                                                   bool as_relax);
   ...
   * \return The input types.
   */
  TVM_DLL static const Array<ffi::String> GetInputTypes(const Call& call);
