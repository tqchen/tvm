...
class CppCodeGen : public BaseCodeGen<ConfigType, HelperType> {
 public:
  ...
  /*! \brief Get sources*/
  virtual const Map<ffi::String, ffi::String> GetSources(const std::string& print_options = "") {
 ...
 protected:
  ...
  virtual const Map<ffi::String, ffi::String> GetTensorCtx(const MSCTensor& tensor) {
  ...
  virtual const Map<ffi::String, ffi::String> GetStepCtx() {
