...
class MSCJSONSerializer : public JSONSerializer {
 public:
   ...
   */
  explicit MSCJSONSerializer(const Map<Constant, ffi::String>& constant_names,
  ...
  const Map<ffi::String, ffi::String> GetOptions() { return options_; }
 ...
 private:
  MSCGraph graph_;
  Map<ffi::String, ffi::String> options_;
