...
class PluginAttr : public ObjectRef {
 public:
   ...
   */
  TVM_DLL PluginAttr(const ffi::String& name, const ffi::String& type, const ffi::String& default_value,
...
class PluginExtern : public ObjectRef {
 public:
   ...
   */
  TVM_DLL PluginExtern(const ffi::String& name, const ffi::String& header, const ffi::String& source,
...
class PluginNode : public Object {
 public:
  ...
  Map<ffi::String, PluginExtern> externs;
  /*! \brief The support_dtypes of plugin. */
  Map<ffi::String, Array<ffi::String>> support_dtypes;
...
class PluginRegistry {
 public:
   ...
   */
  Array<ffi::String> ListAllNames() const {
 ...
 */
const Array<ffi::String> ListPluginNames();
