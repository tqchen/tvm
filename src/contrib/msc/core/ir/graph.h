...
class MSCTensor : public ObjectRef {
 public:
  ...
  TVM_DLL MSCTensor(const ffi::String& name, const DataType& dtype, const ffi::String& layout,
                    ...
                    const Array<ffi::String>& prims = Array<ffi::String>());
...
class BaseJointNode : public Object {
 public:
  ...
  mutable Map<ffi::String, ffi::String> attrs;
...
class MSCJointNode : public BaseJointNode {
 public:
  ...
  void FromJson(const JsonMSCJoint& j_joint, const Map<ffi::String, BaseJoint>& nodes);
  /*! \brief Load node from json string. */
  void FromJson(const std::string& json_str, const Map<ffi::String, BaseJoint>& nodes);
...
class MSCJoint : public BaseJoint {
 public:
   ...
   */
  TVM_DLL MSCJoint(int index, const ffi::String& name, const ffi::String& shared_ref, const ffi::String& optype,
   ...
   */
  TVM_DLL MSCJoint(const JsonMSCJoint& j_joint, const Map<ffi::String, BaseJoint>& nodes);

  /*!
   * \brief The json constructor.
   * \param json_str The json describe of the node.
   */
  TVM_DLL MSCJoint(const std::string& json_str, const Map<ffi::String, BaseJoint>& nodes);
...
class MSCPrimNode : public BaseJointNode {
 public:
  ...
  void FromJson(const JsonMSCPrim& j_prim, const Map<ffi::String, BaseJoint>& prims);
  /*! \brief Load prim from json string. */
  void FromJson(const std::string& json_str, const Map<ffi::String, BaseJoint>& prims);
...
class MSCPrim : public BaseJoint {
 public:
   ...
   */
  TVM_DLL MSCPrim(int index, const ffi::String& name, const ffi::String& optype,
   ...
   */
  TVM_DLL MSCPrim(const JsonMSCPrim& j_prim, const Map<ffi::String, BaseJoint>& prims);

  /*!
   * \brief The json constructor.
   * \param json_str The json describe of the prim.
   */
  TVM_DLL MSCPrim(const std::string& json_str, const Map<ffi::String, BaseJoint>& prims);
...
class WeightJointNode : public BaseJointNode {
 public:
  ...
  /*! \brief Load node from json struct. */
  void FromJson(const JsonWeightJoint& j_joint, const Map<ffi::String, BaseJoint>& nodes);
  /*! \brief Load node from json string. */
  void FromJson(const std::string& json_str, const Map<ffi::String, BaseJoint>& nodes);
  /*! \brief Get parent from the node. */
...
class WeightJoint : public BaseJoint {
 public:
   ...
   */
  TVM_DLL WeightJoint(int index, const ffi::String& name, const ffi::String& shared_ref,
   ...
   * \param j_joint The json describe of the node.
   */
  TVM_DLL WeightJoint(const JsonWeightJoint& j_joint, const Map<ffi::String, BaseJoint>& nodes);

  /*!
   * \brief The json constructor.
   * \param json_str The json describe of the node.
   */
  TVM_DLL WeightJoint(const std::string& json_str, const Map<ffi::String, BaseJoint>& nodes);
...
class BaseGraphNode : public Object {
 public:
  ...
  Array<ffi::String> node_names;
  /*! \brief The nodes in graph, can be changed. */
  Map<ffi::String, BaseJoint> nodes;
...
class MSCGraphNode : public BaseGraphNode {
 public:
  ...
  Array<ffi::String> prim_names;
  /*! \brief The shape nodes in graph. */
  Map<ffi::String, MSCPrim> prims;
  /*! \brief The input names of graph. */
  Array<ffi::String> input_names;
  /*! \brief The output names of graph. */
  Array<ffi::String> output_names;
  /*! \brief The tensor alias in graph, get by AnalysisGraph. */
  mutable Map<ffi::String, ffi::String> tensor_alias;
  /*! \brief The weights in graph, get by AnalysisGraph. */
  Map<ffi::String, Array<ffi::String>> weight_holders;
  ...
  const Array<MSCJoint> FindConsumers(const ffi::String& name) const;
  /*! \brief Find consumers of tensor from the graph. */
  ...
  const std::vector<std::pair<MSCJoint, size_t>> FindConsumersAndIndices(const ffi::String& name) const;
  /*! \brief Find consumers and input indices of tensor from the graph. */
...
class MSCGraph : public BaseGraph {
 public:
   ...
   */
  TVM_DLL MSCGraph(const ffi::String& name, const Array<MSCJoint>& nodes,
...
class WeightGraphNode : public BaseGraphNode {
 public:
  ...
  void Build(const MSCGraph& graph, const Map<ffi::String, Array<ffi::String>>& prunable_types,
             const Map<ffi::String, ffi::String>& relation_types);
  /*! \brief Find node in graph. */
...
class WeightGraph : public BaseGraph {
 public:
   ...
   */
  TVM_DLL WeightGraph(const MSCGraph& graph, const Map<ffi::String, Array<ffi::String>>& prunable_types,
                      const Map<ffi::String, ffi::String>& relation_types);
