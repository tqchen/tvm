...
const std::shared_ptr<std::unordered_map<ffi::String, std::shared_ptr<RelaxOpCode>>> GetRelaxOpCodes() {
  static auto map = std::make_shared<std::unordered_map<ffi::String, std::shared_ptr<RelaxOpCode>>>();
