...
const std::pair<ffi::String, Array<ffi::String>> TFV1OpCode::GetPadding(const ffi::String& strides_key,
                                                              const ffi::String& kernel_key,
                                                              const ffi::String& padding_key) {
  ffi::String pad_mod = "";
  Array<ffi::String> padding;
...
class TFV1AxesCodeGen : public TFV1OpCode {
 public:
  TFV1AxesCodeGen(const ffi::String& func_name, const ffi::String& attr_name) : TFV1OpCode(func_name) {
...
class TFV1AxisCodeGen : public TFV1OpCode {
 public:
  TFV1AxisCodeGen(const ffi::String& func_name, const ffi::String& attr_name) : TFV1OpCode(func_name) {
    attr_name_ = attr_name;
  }
...
class TFV1BatchnormCodeGen : public TFV1OpCode {
 ...
 protected:
  void CodeGenBuild() final {
    ...
    Array<ffi::String> weight_names{"gamma", "beta", "mean", "var"};
    Array<ffi::String> init_names{"gamma", "beta", "moving_mean", "moving_variance"};
...
const std::shared_ptr<std::unordered_map<ffi::String, std::shared_ptr<TFV1OpCode>>> GetTFV1OpCodes() {
  static auto map = std::make_shared<std::unordered_map<ffi::String, std::shared_ptr<TFV1OpCode>>>();
