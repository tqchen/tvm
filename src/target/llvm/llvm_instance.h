...
class LLVMTargetInfo {
 public:
   ...
   */
  const Array<ffi::String> GetAllLLVMTargets() const;
   ...
   */
  const Array<ffi::String> GetAllLLVMTargetArches() const;
   ...
   */
  const Map<ffi::String, ffi::String> GetAllLLVMCpuFeatures() const;
