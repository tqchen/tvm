...
LLVMTargetInfo::LLVMTargetInfo(LLVMInstance& instance, const TargetJSON& target) {
  ...
  if (const auto& v = Downcast<Optional<Array<ffi::String>>>(target.Get("mattr"))) {
  ...
  if (const auto& v = Downcast<Optional<Array<ffi::String>>>(target.Get("cl-opt"))) {
  ...
  if (const auto& v = Downcast<Optional<ffi::String>>(target.Get("mfloat-abi"))) {
  ...
  if (const auto& v = Downcast<Optional<ffi::String>>(target.Get("jit").value_or(nullptr))) {
    ffi::String value = v.value();
  ...
  if (arch == llvm::Triple::riscv32 || arch == llvm::Triple::riscv64) {
    ...
    Map<ffi::String, ffi::String> features = GetAllLLVMCpuFeatures();
    // check vector ISA
...
const Array<ffi::String> LLVMTargetInfo::GetAllLLVMTargets() const {
  Array<ffi::String> llvm_targets;
...
const Array<ffi::String> LLVMTargetInfo::GetAllLLVMTargetArches() const {
  Array<ffi::String> cpu_arches;
...
const Map<ffi::String, ffi::String> LLVMTargetInfo::GetAllLLVMCpuFeatures() const {
  std::string feats = "";
  ...
  Map<ffi::String, ffi::String> cpu_features;
