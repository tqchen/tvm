...
static inline bool MatchesCpu(Optional<ffi::String> mcpu, const Container& cpus) {
  if (!mcpu) {
    return false;
  }
...
static inline bool HasFlag(Optional<ffi::String> attr, std::string flag) {
  if (!attr) {
    return false;
  }
...
static inline bool HasFlag(Optional<Array<ffi::String>> attr, std::string flag) {
  if (!attr) {
    return false;
  }
  Array<ffi::String> attr_array = attr.value();
...
bool IsArch(TargetJSON attrs) {
  Optional<ffi::String> mcpu = Downcast<Optional<ffi::String>>(attrs.Get("mcpu"));
  if (mcpu) {
...
static TargetFeatures GetFeatures(TargetJSON target) {
  Optional<ffi::String> mcpu = Downcast<Optional<ffi::String>>(target.Get("mcpu"));
  Optional<Array<ffi::String>> mattr = Downcast<Optional<Array<ffi::String>>>(target.Get("mattr"));
