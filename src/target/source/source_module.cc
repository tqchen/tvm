...
class SourceModuleNode : public ffi::ModuleObj {
 public:
  ...
  Array<ffi::String> GetWriteFormats() const override { return {fmt_}; }
...
class CSourceModuleNode : public ffi::ModuleObj {
 public:
  CSourceModuleNode(const std::string& code, const std::string& fmt,
                    const Array<ffi::String>& func_names, const Array<ffi::String>& const_vars)
...
TVM_FFI_STATIC_INIT_BLOCK({
  ...
  refl::GlobalDef()
      ...
      .def("runtime.CSourceModuleCreate", [](ffi::String code, ffi::String fmt,
                                             Optional<Array<ffi::String>> func_names,
                                             Optional<Array<ffi::String>> const_vars) {
