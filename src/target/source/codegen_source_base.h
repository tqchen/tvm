 ...
 */
ffi::Module CreateMetadataModule(
    const std::unordered_map<std::string, runtime::NDArray>& params, ffi::Module target_module,
    const Array<ffi::Module>& ext_modules, Target target);
