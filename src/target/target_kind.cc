...
Array<ffi::String> TargetKindRegEntry::ListTargetKinds() {
  return TargetKindRegistry::Global()->ListAllNames();
}

Map<ffi::String, ffi::String> TargetKindRegEntry::ListTargetKindOptions(const TargetKind& target_kind) {
  Map<ffi::String, ffi::String> options;
...
Optional<TargetKind> TargetKind::Get(const ffi::String& target_kind_name) {
...
void CheckOrSetAttr(Map<ffi::String, ffi::Any>* attrs, const ffi::String& name, const ffi::String& value) {
...
TargetJSON UpdateROCmAttrs(TargetJSON target) {
  ...
  if (version < 305) {
    Array<ffi::String> mattr;
    if (target.count("mattr")) {
      mattr = Downcast<Array<ffi::String>>(target.at("mattr"));
    }
...
TargetJSON TestTargetParser(TargetJSON target) {
  Map<ffi::String, ffi::Any> features = {{"is_test", true}};
...
TVM_REGISTER_TARGET_KIND("llvm", kDLCPU)
    .add_attr_option<Array<ffi::String>>("mattr")
    ...
    .add_attr_option<Array<ffi::String>>("cl-opt")
...
TVM_REGISTER_TARGET_KIND("hexagon", kDLHexagon)
    ...
    .add_attr_option<ffi::String>("mcpu")
    .add_attr_option<ffi::String>("mtriple")
    .add_attr_option<Array<ffi::String>>("llvm-options")
    .add_attr_option<int64_t>("num-cores")
