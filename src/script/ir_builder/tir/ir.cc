...
TVM_FFI_STATIC_INIT_BLOCK({
  ...
  refl::GlobalDef()
    ...
    .def("script.ir_builder.tir.Arg", [](String name, ObjectRef obj) -> ObjectRef {
      using namespace tvm::tir;
    ...
    .def("script.ir_builder.tir.LaunchThread", [](ffi::Variant<tvm::tir::Var, String> thread_tag_or_var, PrimExpr extent) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  ...
  refl::GlobalDef()
    ...
    .def("script.ir_builder.tir.min", [](PrimExpr a, PrimExpr b) -> PrimExpr { return tvm::min(a, b); })
    .def("script.ir_builder.tir.max", [](PrimExpr a, PrimExpr b) -> PrimExpr { return tvm::max(a, b); });
});
}  // namespace tir
}  // namespace ir_builder
}  // namespace script
