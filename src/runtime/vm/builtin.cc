...
void MatchShape(ffi::PackedArgs args, ffi::Any* rv) {
  ...
  Optional<ffi::String> err_ctx = args[kErrorContextOffset].cast<ffi::String>();
...
void CheckTensorInfo(ffi::PackedArgs args, ffi::Any* rv) {
  ...
  if (args.size() == 3) {
    dtype = DataType::Void();
    err_ctx = args[2].cast<Optional<ffi::String>>();
  } else {
    dtype = args[2].cast<DataType>();
    err_ctx = args[3].cast<Optional<ffi::String>>();
  }
 ...
 * \param err_ctx Additional context if error occurs.
 */
void CheckShapeInfo(ObjectRef arg, int ndim, Optional<ffi::String> err_ctx) {
  // a function that lazily get context for error reporting
 ...
 * \param err_ctx Additional context if error occurs.
 */
void CheckPrimValueInfo(ffi::AnyView arg, DataType dtype, Optional<ffi::String> err_ctx) {
 ...
 * \param err_ctx Additional context if error occurs.
 */
void CheckTupleInfo(ObjectRef arg, int64_t size, Optional<ffi::String> err_ctx) {
  // a function that lazily get context for error reporting
 ...
 * \param err_ctx Additional context if error occurs.
 */
void CheckFuncInfo(ObjectRef arg, Optional<ffi::String> err_ctx) {
  // a function that lazily get context for error reporting
