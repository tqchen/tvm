...
TVM_FFI_STATIC_INIT_BLOCK({
  ...
  refl::GlobalDef()
    .def("vm.builtin.alloc_shape_heap", AllocShapeHeap);
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("vm.builtin.match_prim_value", MatchPrimValue);
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def_packed("vm.builtin.match_shape", MatchShape);
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("vm.builtin.make_prim_value", MakePrimValue);
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def_packed("vm.builtin.make_shape", MakeShape);
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def_packed("vm.builtin.check_tensor_info", CheckTensorInfo);
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("vm.builtin.check_shape_info", CheckShapeInfo);
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("vm.builtin.check_prim_value_info", CheckPrimValueInfo);
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("vm.builtin.check_tuple_info", CheckTupleInfo);
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("vm.builtin.check_func_info", CheckFuncInfo);
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def_packed("vm.builtin.make_closure", [](ffi::PackedArgs args, ffi::Any* rv) {
    ...
    .def_packed("vm.builtin.invoke_closure", [](ffi::PackedArgs args, ffi::Any* rv) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  ...
  refl::GlobalDef()
    ...
    .def("vm.builtin.reshape", [](NDArray data, ffi::Shape new_shape) {
      return data.CreateView(new_shape, data->dtype);
    })
    .def("vm.builtin.null_value", []() -> std::nullptr_t {
  return nullptr;
})
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("vm.builtin.read_if_cond", ReadIfCond);
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def_packed("vm.builtin.invoke_debug_func", [](ffi::PackedArgs args, ffi::Any* rv) -> void {
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef()
    .def("vm.builtin.tuple_getitem", [](Array<ffi::Any> arr, int64_t index) { return arr[index]; })
    .def("vm.builtin.tuple_reset_item", [](const ffi::ArrayObj* arr, int64_t index) {
      const_cast<ffi::ArrayObj*>(arr)->SetItem(index, nullptr);
    })
    .def_packed("vm.builtin.make_tuple", [](ffi::PackedArgs args, ffi::Any* rv) {
      Array<ffi::Any> arr;
    ...
    .def("vm.builtin.tensor_to_shape", [](NDArray data) {
  NDArray arr = data;
