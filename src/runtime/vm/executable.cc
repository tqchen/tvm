...
void VMExecutable::ExportToFile(const String& file_name, const String& format) const {
...
TVM_FFI_STATIC_INIT_BLOCK({
  ...
  refl::GlobalDef().def("ffi.Module.load_from_bytes.VMExecutable",
                        VMExecutable::LoadFromBytes);
});
...
TVM_FFI_STATIC_INIT_BLOCK({
  namespace refl = tvm::ffi::reflection;
  refl::GlobalDef().def("ffi::Module.load_from_file.relax.VMExecutable", VMExecutable::LoadFromFile);
});
