...
TVM_FFI_STATIC_INIT_BLOCK({
  ...
  refl::GlobalDef()
    .def("vm.builtin.hexagon.dma_copy", [](ffi::AnyView vm_ptr, NDArray src_arr, NDArray dst_arr, int queue_id,
                       bool bypass_cache) {
    ...
    .def("vm.builtin.hexagon.dma_wait", [](ffi::AnyView vm_ptr, int queue_id, int inflight_dma, bool bypass_cache,
