...
Map<ffi::String, Tensor> LoadParams(const std::string& param_blob) {
  dmlc::MemoryStringStream strm(const_cast<std::string*>(&param_blob));
  return LoadParams(&strm);
}
Map<ffi::String, Tensor> LoadParams(dmlc::Stream* strm) {
  Map<ffi::String, Tensor> params;
...
void SaveParams(dmlc::Stream* strm, const Map<ffi::String, Tensor>& params) {
  std::vector<std::string> names;
...
std::string SaveParams(const Map<ffi::String, Tensor>& params) {
  std::string bytes;
