...
ffi::String ShapeString(Tensor shape, DLDataType dtype) { return ShapeString(ToShape(shape), dtype); }
...
ffi::String ReportNode::AsTable(bool sort, bool aggregate, bool compute_col_sums) const {
  ...
  std::vector<Map<ffi::String, ffi::Any>> aggregated_calls;
  if (aggregate) {
  ...
  if (sort) {
    std::sort(aggregated_calls.begin(), aggregated_calls.end(),
              [&](const Map<ffi::String, ffi::Any>& a, const Map<ffi::String, ffi::Any>& b) {
  ...
  for (auto p : device_metrics) {
    Map<ffi::String, ffi::Any> metrics = p.second;
...
Report Profiler::Report() {
  ...
  std::unordered_map<ffi::String, Map<ffi::String, ffi::Any>> device_metrics;
  for (size_t i = 0; i < devs_.size(); i++) {
  ...
  // convert to map
  std::vector<Map<ffi::String, ffi::Any>> converted_rows;
...
Report::Report(Array<Map<ffi::String, ffi::Any>> calls,
               Map<ffi::String, Map<ffi::String, ffi::Any>> device_metrics,
               Map<ffi::String, ffi::Any> configuration) {
...
Map<ffi::String, ffi::Any> parse_metrics(dmlc::JSONReader* reader) {
  reader->BeginObject();
  std::string metric_name, metric_value_name;
  Map<ffi::String, ffi::Any> metrics;
...
Report Report::FromJSON(ffi::String json) {
  ...
  std::string key;
  Array<Map<ffi::String, ffi::Any>> calls;
  Map<ffi::String, Map<ffi::String, ffi::Any>> device_metrics;
  Map<ffi::String, ffi::Any> configuration;
...
ffi::Function ProfileFunction(ffi::Module mod, std::string func_name, int device_type,
  ...
  return ffi::Function::FromPacked([=](const ffi::AnyView* args, int32_t num_args,
    ...
    std::vector<Map<ffi::String, ffi::Any>> results;
    ...
    Map<ffi::String, ffi::Any> combined_results;
    for (auto m : results) {
      for (auto p : m) {
...
TVM_FFI_STATIC_INIT_BLOCK({
  ...
  refl::GlobalDef()
      .def("runtime.profiling.Report",
           [](Array<Map<ffi::String, ffi::Any>> calls, Map<ffi::String, Map<ffi::String, ffi::Any>> device_metrics,
              Map<ffi::String, ffi::Any> configuration) {
             return Report(calls, device_metrics, configuration);
           })
