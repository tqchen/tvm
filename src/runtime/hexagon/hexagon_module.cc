...
Optional<ffi::Function> HexagonModuleNode::GetFunction(const String& name) {
...
void HexagonModuleNode::ExportToFile(const String& file_name, const String& format) const {
