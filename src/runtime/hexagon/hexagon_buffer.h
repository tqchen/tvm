...
class HexagonBuffer {
 public:
   ...
   * memory (DDR).
   */
  HexagonBuffer(size_t nbytes, size_t alignment, Optional<ffi::String> scope);
   ...
   * memory (DDR).
   */
  HexagonBuffer(size_t nallocs, size_t nbytes, size_t alignment, Optional<ffi::String> scope);
 ...
 private:
  ...
  void SetStorageScope(Optional<ffi::String> scope);
