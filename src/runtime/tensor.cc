...
Tensor Tensor::Empty(ffi::Shape shape, DLDataType dtype, Device dev, Optional<ffi::String> mem_scope) {
...
Tensor Tensor::CopyTo(const Device& dev, Optional<ffi::String> mem_scope) const {
  ICHECK(data_ != nullptr);
