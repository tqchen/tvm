...
class MarvellSimulatorModuleNode : public ffi::ModuleObj {
 public:
  ...
  const char* kind() const { return "mrvl_sim"; }
...
ffi::Module MarvellSimulatorModuleRuntimeCreate(const ffi::String& symbol_name, const ffi::String& nodes_json,
                                                const ffi::String& bin_code) {
  auto n = ffi::make_object<MarvellSimulatorModuleNode>(symbol_name, nodes_json, bin_code);
  return ffi::Module(n);
}
