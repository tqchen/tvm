...
class OpenCLWorkspace : public DeviceAPI {
 public:
  ...
  void* AllocDataSpaceView(Device dev, void* data, ffi::Shape shape, DLDataType dtype,
                           Optional<ffi::String> mem_scope = std::nullopt);
  ...
  void* AllocDataSpace(Device dev, int ndim, const int64_t* shape, DLDataType dtype,
                       Optional<ffi::String> mem_scope = std::nullopt) final;
  ...
  size_t GetDataSize(const DLTensor& arr, Optional<ffi::String> mem_scope = std::nullopt) final;
  ...
  void* AllocCLImage(Device dev, void* back_buffer, size_t width, size_t height, size_t row_pitch,
                     DLDataType type_hint, Optional<ffi::String> mem_scope);
...
struct BufferDescriptor {
  ...
  explicit BufferDescriptor(Optional<ffi::String> scope) : layout(MemoryLayoutFromScope(scope)) {}
  static MemoryLayout MemoryLayoutFromScope(Optional<ffi::String> mem_scope);
