...
Optional<ffi::Function> MetalModuleNode::GetFunction(const ffi::String& name) {
  ffi::Function ret;
  AUTORELEASEPOOL {
...
TVM_FFI_STATIC_INIT_BLOCK({
  ...
  refl::GlobalDef().def(
      ...
      [](Map<ffi::String, ffi::String> smap, std::string fmap_json, std::string fmt, std::string source) {
