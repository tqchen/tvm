...
class CUDANamespace:
    ...
    def __init__(self):
        ...
        self.copy_bytes = _op_wrapper(_cuda_op.cuda_copy_bytes)
        self.copy_128b = _op_wrapper(_cuda_op.cuda_copy_128b)
        self.copy_64b = _op_wrapper(_cuda_op.cuda_copy_64b)
        self.copy_32b = _op_wrapper(_cuda_op.cuda_copy_32b)
        self.copy_16b = _op_wrapper(_cuda_op.cuda_copy_16b)
        self.copy_8b = _op_wrapper(_cuda_op.cuda_copy_8b)
