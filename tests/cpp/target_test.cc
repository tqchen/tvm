...
TVM_REGISTER_TARGET_KIND("TestTargetKind", kDLCPU)
    ...
    .add_attr_option<Array<ffi::String>>("your_names")
    .add_attr_option<Map<ffi::String, int64_t>>("her_maps");
...
TargetJSON TestTargetParser(TargetJSON target) {
  ...
  target.Set("keys", Array<ffi::String>({"super"}));
  target.Set("features", Map<ffi::String, ffi::Any>{{"test", true}});
  return target;
}

Map<ffi::String, ffi::Any> TestAttrsPreProcessor(Map<ffi::String, ffi::Any> attrs) {
...
TEST(TargetCreation, NestedConfig) {
  Map<ffi::String, ffi::Any> config = {
      {"my_bool", true},
      {"your_names", Array<ffi::String>{"junru", "jian"}},
      {"kind", ffi::String("TestTargetKind")},
      {
          "her_maps",
          Map<ffi::String, int64_t>{
              {"a", 1},
              {"b", 2},
          },
      },
  ...
  Array<ffi::String> your_names = target->GetAttr<Array<ffi::String>>("your_names").value();
  ICHECK_EQ(your_names.size(), 2U);
  ICHECK_EQ(your_names[0], "junru");
  ICHECK_EQ(your_names[1], "jian");
  Map<ffi::String, int64_t> her_maps = target->GetAttr<Map<ffi::String, int64_t>>("her_maps").value();
...
TEST(TargetCreation, TargetFeaturesBeforeParser) {
  Map<ffi::String, ffi::Any> features = {{"test", true}};
  Map<ffi::String, ffi::Any> config = {
...
TVM_REGISTER_TARGET_KIND("TestStringKind", kDLCPU)
    ...
    .add_attr_option<Array<ffi::String>>("array")
    .add_attr_option<Array<Array<ffi::String>>>("nested-array")
    .add_attr_option<Array<Array<Array<ffi::String>>>>("nested2-array");
...
TEST(TargetCreation, ProcessStrings) {
  ...
  ASSERT_TRUE(test_target3->GetAttr<Array<ffi::String>>("array"));
  Array<ffi::String> array3 = test_target3->GetAttr<Array<ffi::String>>("array").value();
  ...
  ASSERT_TRUE(test_target4->GetAttr<Array<ffi::String>>("array"));
  Array<ffi::String> array4 = test_target4->GetAttr<Array<ffi::String>>("array").value();
  ASSERT_EQ(array4[0], "fred, foo, bar");
  ASSERT_EQ(array4[1], "baz");

  Target test_target5("TestStringKind -array='fr\\'ed','f\\'oo',' bar,baz '");
  ASSERT_TRUE(test_target5->GetAttr<Array<ffi::String>>("array"));
  Array<ffi::String> array5 = test_target5->GetAttr<Array<ffi::String>>("array").value();
  ...
  ASSERT_TRUE(test_target6->GetAttr<Array<Array<ffi::String>>>("nested-array"));
  Array<Array<ffi::String>> array6 = test_target6->GetAttr<Array<Array<ffi::String>>>("nested-array").value();
  ...
  ASSERT_TRUE(test_target7->GetAttr<Array<Array<Array<ffi::String>>>>("nested2-array"));
  Array<Array<Array<ffi::String>>> array7 =
      test_target7->GetAttr<Array<Array<Array<ffi::String>>>>("nested2-array").value();
  // {
  //   {foo0, foo1},
  //   {bar0, bar1},
  //   {baz0, baz1},
...
TEST(TargetCreation, DetectSystemTriple) {
  ...
  Optional<ffi::String> mtriple = target->GetAttr<ffi::String>("mtriple");
...
TEST(TargetCreation, DeduplicateKeys) {
  Map<ffi::String, ffi::Any> config = {
      {"kind", ffi::String("llvm")},
      {"keys", Array<ffi::String>{"cpu", "arm_cpu"}},
...
TEST(TargetKindRegistry, ListTargetKinds) {
  Array<ffi::String> names = TargetKindRegEntry::ListTargetKinds();
...
TEST(TargetKindRegistry, ListTargetOptions) {
  ...
  Map<ffi::String, ffi::String> attrs = TargetKindRegEntry::ListTargetKindOptions(llvm);
