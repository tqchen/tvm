...
class Report : public ObjectRef {
 public:
   ...
   */
  explicit Report(Array<Map<ffi::String, ffi::Any>> calls,
                  Map<ffi::String, Map<ffi::String, ffi::Any>> device_metrics,
                  Map<ffi::String, ffi::Any> configuration);
...
class MetricCollectorNode : public Object {
 public:
   ...
   */
  virtual Map<ffi::String, ffi::Any> Stop(ffi::ObjectRef obj) = 0;
 ...
 *          and returns performance metrics as a `Map<ffi::String, ffi::Any>` where
