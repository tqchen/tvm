...
class TargetTag : public ObjectRef {
 public:
   ...
   */
  TVM_DLL static Optional<Target> Get(const ffi::String& target_tag_name);
  /*!
   ...
   */
  TVM_DLL static Map<ffi::String, Target> ListTags();
  /*!
   ...
   */
  TVM_DLL static Target AddTag(ffi::String name, Map<ffi::String, Any> config, bool override);
...
class TargetTagRegEntry {
 public:
   ...
   */
  inline TargetTagRegEntry& set_config(Map<ffi::String, Any> config);
  /*!
...
inline TargetTagRegEntry& TargetTagRegEntry::set_config(Map<ffi::String, Any> config) {
