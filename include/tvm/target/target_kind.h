 ...
 */
using TargetFeatures = Map<ffi::String, ffi::Any>;
 ...
 */
using TargetJSON = Map<ffi::String, ffi::Any>;
...
class TargetKind : public ObjectRef {
 public:
   ...
   */
  TVM_DLL static Optional<TargetKind> Get(const ffi::String& target_kind_name);
...
class TargetKindRegEntry {
 public:
   ...
   */
  TVM_DLL static Array<ffi::String> ListTargetKinds();
  /*!
   * \brief Get all supported option names and types for a given Target kind.
   * \return Map of option name to type
   */
  TVM_DLL static Map<ffi::String, ffi::String> ListTargetKindOptions(const TargetKind& kind);
