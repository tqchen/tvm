 ...
 * \brief Optional JSON parsing and serialization utilities
 */
#ifndef TVM_FFI_JSON_JSON_H_
#define TVM_FFI_JSON_JSON_H_
 ...
 */
TVM_FFI_EXTRA_CXX_API String Stringify(const json::Value& value, int indent = -1);

}  // namespace json
}  // namespace ffi
}  // namespace tvm
#endif  // TVM_FFI_JSON_JSON_H_
