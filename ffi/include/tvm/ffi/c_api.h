 ...
 */
inline TVMFFIByteArray TVMFFISmallStrGetContentByteArray(const TVMFFIAny* value) {
  return TVMFFIByteArray{reinterpret_cast<const char*>(value->small_str_header + 1),
                         static_cast<size_t>(value->small_str_header[0])};
}
