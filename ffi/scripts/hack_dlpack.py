...
ScalarType toScalarType(const DLDataType& dtype) {
  ...
  TORCH_CHECK_INDEX(dtype.lanes == 1, "ATen does not support lanes != 1");
  switch (dtype.code) {
    ...
    case DLDataTypeCode::kDLBool:
      ...
      break;
    default:
      TORCH_CHECK_INDEX(false, "Unsupported code ", std::to_string(dtype.code));
  }
  return stype;
}
...
DLManagedTensor* toDLPackX(const at::Tensor& src) {
